 ...
 *
 * Importação de estilos (obrigatória no entry da app consumidora):
 *   import '@rankmyapp/ds/styles'
 *
 * Importação de componentes:
 *   import { Button, Badge, Card } from '@rankmyapp/ds'
 *
 * Importação de tokens TypeScript:
 *   import { getChartColors, semantic } from '@rankmyapp/ds/tokens'
 *
 * Importação do preset Tailwind:
...
// ── Theme (Provider + hook + utilitários puros) ───────────────────────────────
